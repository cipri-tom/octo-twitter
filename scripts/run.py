...
# Eval Parameters
tf.flags.DEFINE_string("checkpoint_dir", "../data/1482182487/checkpoints", "Checkpoint directory from training run")  # pls. make sure that you put the downloaded checkpoint here!
...
# Build vocabulary
x_test = helpers.map_test_data(x_text, FLAGS.max_document_length, saved_vocab_file="../data/submission_vocab.pkl")
