...
# tf.flags.DEFINE_string("word2vec", "../data/GoogleNews-vectors-negative300.bin", "Word2vec file with pre-trained embeddings (default: ../data/GoogleNews-vectors-negative300.bin)")
# tf.flags.DEFINE_string("GloVe", None, "GloVe vectors with pre-trained embeddings (default: ../data/glove.twitter.27B.200d.txt)")
